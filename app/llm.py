...
def llm_res(text,airport_code):
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            ...
            4. Note this carefully you have to figure out the correct airport city using airport code provided by user.
            5. If you got the airport city then you have to extract the details for single_trip field( above written json field ) where source_location is that airport city and extract the round_trip field(above written json field) where arrival_location is that airport city.
