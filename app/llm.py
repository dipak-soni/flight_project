...
def llm_res(text,airport_code):
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            ...
            5. If you got the airport city then you have to extract the details for single_trip field( above written json field ) where arrival_location is that either airport city or that airport name and extract the round_trip field(above written json field) where source_location is the either airport city or airport name.
            6. arrival_location in single_trip field and source_location should be equal.
